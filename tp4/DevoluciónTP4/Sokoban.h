...
private:
    ...
    // TODO: En vez de tener como variable interna un puntero a Nivel,
    //  podrías tener directamente un Nivel (y el constructor podría
    //  recibir un Nivel en vez de un puntero a Nivel).
    Nivel *_nivel;
