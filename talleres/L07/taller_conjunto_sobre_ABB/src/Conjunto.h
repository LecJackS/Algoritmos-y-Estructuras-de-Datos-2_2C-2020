...
class Conjunto
{
    ...
    private:
        ...
        struct Nodo
        {
            ...
            Nodo* der;
            // Puntero al nodo parent.
            Nodo* parent;
        };

        Nodo* tree_search(const T& v) const;
        void tree_insert(const T& v);
        Nodo* tree_min(Nodo *x) const;
        Nodo* tree_max(Nodo *x) const;
        void transplant(Nodo *a, Nodo *b);
        void tree_delete(Nodo *a);
        Nodo* tree_successor(Nodo* x);
        void destruir(Nodo* x);
